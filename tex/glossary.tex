...
%    Defined such that 50\% of the entire assembly is contained in contigs or scaffolds equal to or larger than this value. \\
    ...
    %            lengths of the contigs in the assemblyâ€ \\ % https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4426941/pdf/bbi-9-2015-075.pdf (cites 49, 50)
...
\textbf{TPM} & %Transcripts per million \cite{wagner2012}, an alternative to RPKM \cite{mortazavi2008} \\
	...
	% Count up all the RPK values in a sample and divide this number by 1,000,000. This is your Òper millionÓ scaling factor.
	% Divide the RPK values by the Òper millionÓ scaling factor. This gives you TPM.
