...
\subsubsection{Goals of this study}  % \section{Introduction}
...
\subsection{Challenges and Strategies}  % \section{Introduction}
...
The following sections describe these challenges in more detail, and approaches we took to provide a coarse description microbial abundances and metabolic contributions.
...
%==========================================================================================================================================
%==========================================================================================================================================
\section{Metagenomics and Metatranscriptomics}  % \section{Metagenomics and Metatranscriptomics}
...
\subsubsection{Metagenomics/Metatranscriptomics Tool Selection \& Challenges}   % \section{Metagenomics and Metatranscriptomics}
...
\subsubsection{Assembly}   % \section{Metagenomics and Metatranscriptomics}
%---- Why assemble
...
\subsection{Elviz Assemblies}   % \section{Metagenomics and Metatranscriptomics}
%---- JGI assemblies
...
\subsubsection{Binning}   % \section{Metagenomics and Metatranscriptomics}
%---- Definition & Why
...
\subsubsection{Mapping RNA}   % \section{Metagenomics and Metatranscriptomics}
...
%after that step, as the estimates will certainly be wrong some of the time.
...
See the supplementary attachments for the gene \texttt{.fasta} and corresponding \texttt{.gff} files. %, and RNA read counts \texttt{.tsv} in each sample.
...
%Through these steps, we expect to develop a more precise understanding of this complex community.
...
If the fraction of reads mapping to these longer contigs is not sufficient for future publication, assembly can be revisited.% (see below), or goals should be readjusted.
