...
Prokka did not tolerate an input size of the scale, so the input fasta was broken into 5 of approximately equal size.
...
In the end, the largest data it could handle was using settings 56mer, lt 0.4, st 50, on contigs $\geq 2.5$ kb.
