...
%This thesis aims to describe the community holistically, and thus strives to clearly report assembly, binning, and read mapping efficacy so as to not overstate claims or exaggerate community simplicity.
...
The statistics it returned for these positive controls were nearly perfect (Table \ref{tab:checkm_isolate}), indicating that good bins for these samples should have nearly 100\% completeness and less than a few percent contamination.
