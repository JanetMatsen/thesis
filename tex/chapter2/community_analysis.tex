...
Given the small fraction of the metagenomes explained by MetaBAT (Figure \cite{fig:mycc_contamination}), and high contamination scores of the MyCC bins (Figure \ref{fig:mycc_contamination}), binning has been placed on hold.
