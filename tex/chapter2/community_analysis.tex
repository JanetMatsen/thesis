...
% For example, if you had a 10kb contig with 2 arbitrary units of coverage, you do not want your estimate of abundance to double upon splitting that contig into two 5kb contigs, each with 2 units of coverage.
