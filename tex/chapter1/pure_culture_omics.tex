...
The activity of the enzyme \textit{in vivo} requires cytochrome c$_L$ (\textit{mxaG}) and a number of chaperones, regulators, and enzymes, including genes required for \ce{Ca^{2+}} insertion \cite{anthony1994, anthony2002}.
...
The second homolog of Ppc (\textit{ppc2}) clusters with anaplerotic “regulated” PEP carboxylases, which are controlled by a variety of metabolic effectors \cite{takahashi1993, kai2003}.
